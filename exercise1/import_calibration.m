function K = import_calibration(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   K = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   K = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   K = importfile('K.txt', 1, 3);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/10/30 02:52:06
