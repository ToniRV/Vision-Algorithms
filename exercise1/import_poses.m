function poses1 = import_poses(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   POSES1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   POSES1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   poses1 = importfile('poses.txt', 1, 736);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/10/30 02:49:29
